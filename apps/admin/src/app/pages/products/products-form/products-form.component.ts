...
import { CategoriesService, Category, ProductsService } from '@jontyjr/products';
  ...
  ngOnInit(): void {
   ...
   private _initForm(){
    ...
    private _updateProduct(productFormData:FormData){
      this.productsService.updateCategory(productFormData,this.currentProductId).subscribe((response) =>{
